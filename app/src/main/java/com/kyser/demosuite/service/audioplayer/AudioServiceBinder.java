...
import com.kyser.demosuite.service.messagingservice.MessagingService;
...
public class AudioServiceBinder extends Binder {
    ...
    // This Handler object is a reference to the caller activity's Handler.  In the caller activity's handler, it will update the audio play progress.
